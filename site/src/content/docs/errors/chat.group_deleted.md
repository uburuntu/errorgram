---
title: "Chat group deleted · chat.group_deleted"
description: "Telegram reports that the group chat was deleted."
slug: "errors/chat.group_deleted"
editUrl: "https://github.com/uburuntu/errorgram/edit/main/catalogue/errors.json"
sidebar:
  label: "chat.group_deleted"
---
...
[Markdown](/errors/chat.group_deleted.md) · [Condition JSON](/errors/chat.group_deleted.json) · [Full catalogue and sources](/catalogue.json) · [JSON Schema](/schema.json)
