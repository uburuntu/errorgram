---
title: "Chat not found · chat.not_found"
description: "The bot could not resolve this chat."
slug: "errors/chat.not_found"
editUrl: "https://github.com/uburuntu/errorgram/edit/main/catalogue/errors.json"
sidebar:
  label: "chat.not_found"
---
...
[Markdown](/errors/chat.not_found.md) · [Condition JSON](/errors/chat.not_found.json) · [Full catalogue and sources](/catalogue.json) · [JSON Schema](/schema.json)
