---
title: "Format entity not object · format.entity_not_object"
description: "An item in the message entities array is not a JSON object."
slug: "errors/format.entity_not_object"
editUrl: "https://github.com/uburuntu/errorgram/edit/main/catalogue/errors.json"
sidebar:
  label: "format.entity_not_object"
---
...
[Markdown](/errors/format.entity_not_object.md) · [Condition JSON](/errors/format.entity_not_object.json) · [Full catalogue and sources](/catalogue.json) · [JSON Schema](/schema.json)
