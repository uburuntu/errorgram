---
title: "Format entity type unsupported · format.entity_type_unsupported"
description: "A message entity specifies an unsupported type."
slug: "errors/format.entity_type_unsupported"
editUrl: "https://github.com/uburuntu/errorgram/edit/main/catalogue/errors.json"
sidebar:
  label: "format.entity_type_unsupported"
---
...
[Markdown](/errors/format.entity_type_unsupported.md) · [Condition JSON](/errors/format.entity_type_unsupported.json) · [Full catalogue and sources](/catalogue.json) · [JSON Schema](/schema.json)
