---
title: "Server restarting · server.restarting"
description: "The bot client is closing for a server restart."
slug: "errors/server.restarting"
...
[Markdown](/errors/server.restarting.md) · [Condition JSON](/errors/server.restarting.json) · [Full catalogue and sources](/catalogue.json) · [JSON Schema](/schema.json)
